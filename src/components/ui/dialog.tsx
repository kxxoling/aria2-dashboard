...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // w-[calc(100%-2rem)]: keep a screen-edge gutter on narrow viewports
        // (percentages of a fixed box resolve against the viewport);
        // [&>*]:min-w-0: grid items default to min-width:auto, so long task
        // names/files would stretch the dialog past the screen instead of
        // truncating — let every child shrink and clip inside the dialog.
